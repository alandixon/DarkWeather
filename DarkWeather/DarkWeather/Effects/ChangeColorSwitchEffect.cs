...
namespace DarkWeather
{
    ...
    public class ChangeColorSwitchEffect : RoutingEffect
    {
        ...
        /// <summary>
        /// [assembly: ResolutionGroupName("DarkWeather")] moved to the AssemblyInfo classes in the platform projects
        /// </summary>
        public ChangeColorSwitchEffect() : base("DarkWeather.ChangeColorSwitchEffect")
        {
        }
